...
<tr  width= "100%" bgcolor="#0033CC" class="td_data">
	<td width= "100%" align= "center" bgcolor="#003372"><span><strong><em>Exams Center Notice Board</em></strong></span></td>
...
<tr class="td_data" width="100%">
     ...
     <td width="100%"><h3><?php echo $topic ; ?></h3> 
       <em><strong>-- Center Manage</strong></em><strong>r</strong> <?php echo $PostTime ; ?></td>
    
   
  </tr>	
  <tr bgcolor="#999999" class="td_data" width="100%">
     
     <td colspan="10" width="100%" bgcolor="#999999"><strong><span>&nbsp;&nbsp;&nbsp;<? echo $message; ?></span></strong></td>
...
<tr  width= "100%" bgcolor="#000000" class="td_data">
   <td width= "100%" align= "center" bgcolor="#003372"><span><strong>Islamic Online University Exam Centers Registration Portal</strong></span></td></tr>
