...
<body>
<div id="page_header">
<img src="http://bais.islamiconlineuniversity.com/bais/center/buttons/examcenter.jpg" width="750"/></div>
<div id="page_content">


<table width= "100%" border="0"><tr  width= "100%"  class="menu1">	<td width= "82%" height="40" align= "center"><strong>
  
</strong>      
<td width="17%"><a id=noticelink href="examcenternotice.php" class="menu3"><strong>Notice Board</strong></a></td>
<td width="1%"></td>      </tr></table>     
 ...
 <table id="layout-table" summary="layout" width="100%"><tr>          <td id="middle-column" width="100%" valign="top"><span id="maincontent"></span>                     
      <p class="class2"><?
    ...
    <p class="class2" >  <?
      ...
      <p class="class6">To find an exam center in your area </p>
       ...
       <p class="class6">  If there is no center suitable for you </p>
         ...
         <li>You may suggest a new center by <a href="http://bais.islamiconlineuniversity.com/bais/center/centersuggest.php"> clicking here</a></li>
        </ul>
